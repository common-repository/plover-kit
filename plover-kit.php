...
if ( !defined( 'PLOVER_KIT_VERSION' ) ) {
    define( 'PLOVER_KIT_VERSION', '1.2.4' );
}
...
if ( function_exists( 'plover_fs' ) ) {
    ...
    $bootstrap = \Plover\Core\Bootstrap::make( PLOVER_KIT_SLUG, dirname( __FILE__ ), ( version_compare( \Plover\Core\Plover::VERSION, '1.0.6', '>=' ) ? plugin_dir_url( __FILE__ ) : [] ) );
