...
Patterns & Pluggable modules that enhance the Block editor editing experience. Text/drop/box shadows, sticky block, code highlight, icon library, etc.
...
Extra text-shadow, drop-shadow, and box-shadow support for code blocks.
...
* Fix: Update code snippet status error
